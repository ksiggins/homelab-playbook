...
class PathClassificationTests(unittest.TestCase):
    ...
    def test_current_security_validation_and_renamed_role_mappings(self) -> None:
        mappings = {
            ...
            "playbooks/tls/provision.yml": "molecule",
            "playbooks/tls/renew.yml": "molecule",
            "playbooks/tls/verify.yml": "molecule",
            "roles/tls_automation/files/tls_runtime/runtime.py": "molecule",
